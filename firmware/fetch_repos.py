...
def clone_or_update_repo(
    ...
    if patch_path:
        ...
        # --ignore-whitespace: on Windows, Git's CRLF conversion makes the patch
        # fail to apply and the script silently "skips" it (exit 0), leading to
        # baffling downstream build errors. Ignoring whitespace makes it robust.
